...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.KeycloakID = field.NewString(tableName, "keycloak_id")
...
func (u *user) updateTableName(table string) *user {
	...
	u.KeycloakID = field.NewString(table, "keycloak_id")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["id"] = u.ID
	u.fieldMap["keycloak_id"] = u.KeycloakID
