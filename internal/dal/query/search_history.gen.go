...
func newSearchHistory(db *gorm.DB, opts ...gen.DOOption) searchHistory {
	...
	_searchHistory.ID = field.NewInt64(tableName, "id")
	_searchHistory.UserID = field.NewInt64(tableName, "user_id")
	_searchHistory.Query = field.NewString(tableName, "query")
	_searchHistory.SearchCount = field.NewInt32(tableName, "search_count")
	_searchHistory.LastResultCount = field.NewInt32(tableName, "last_result_count")
	_searchHistory.LastSearchedAt = field.NewTime(tableName, "last_searched_at")
	_searchHistory.CreatedAt = field.NewTime(tableName, "created_at")
	_searchHistory.UpdatedAt = field.NewTime(tableName, "updated_at")
...
type searchHistory struct {
	...
	UserID          field.Int64
	Query           field.String
	SearchCount     field.Int32
	LastResultCount field.Int32
	LastSearchedAt  field.Time
...
func (s *searchHistory) updateTableName(table string) *searchHistory {
	...
	s.SearchCount = field.NewInt32(table, "search_count")
	s.LastResultCount = field.NewInt32(table, "last_result_count")
	s.LastSearchedAt = field.NewTime(table, "last_searched_at")
...
func (s *searchHistory) fillFieldMap() {
	...
	s.fieldMap["search_count"] = s.SearchCount
	s.fieldMap["last_result_count"] = s.LastResultCount
	s.fieldMap["last_searched_at"] = s.LastSearchedAt
